...
public class GearTest extends Utility {
    ...
    public void userShouldAddProductSuccessfullyToShoppingCart()
    {
        ...
        String expextedText1 = "You added Overnight Duffle to your shopping cart.";
        ...
        Assert.assertEquals("You added Overnight Duffle to your shopping cart.", expextedText1,actualText1);
        ...
        WebElement qty1 = driver.findElement(By.xpath("//a[contains(text(),'Overnight Duffle')]"));
        qty1.clear();
        qty1.sendKeys("3");
